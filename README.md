...
Version 1.8.3 - https://github.com/niclasleonbock/UrlRewrite/releases/tag/v1.8.3
* Added support for Sitecore 9.x
* Fixed redirect layout definition
* Upgraded to target framework 4.6
* Fixed bug with Tracker.Current being null
